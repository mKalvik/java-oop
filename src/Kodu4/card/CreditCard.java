...
public class CreditCard extends DebitCard {
    ...
    private CreditCard(BigDecimal initialBalance) {
    ...
    public static CreditCard createNewCreditCard(BigDecimal initialAmount) {
        return new CreditCard(initialAmount);
    }
    ...
    public void makePayment(BigDecimal amount) {
        if (isAboveLimit(amount)) {
            ...
            super.substractBalance(amount);
            System.out.println("Credit card payment successful. Amount: " + amount + " Balance: " + getBalance());
        }
    }
